        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gener = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacs_HospitalInfos_HospitalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrescibedMedicines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrescibedMedicines_Medicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PrescibedMedicines_PatientReport_PatientReportId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescibedMedicines_MedicineId",
                table: "PrescibedMedicines",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_PrescibedMedicines_PatientReportId",
                table: "PrescibedMedicines",
